...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Version.hack'
        db.alter_column('hack_version', 'hack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hack.Hack'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Version.hack'
        db.alter_column('hack_version', 'hack_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hack.Hack']))
