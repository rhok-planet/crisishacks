...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field usage on 'Hack'
        db.create_table('hack_hack_usage', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('hack', models.ForeignKey(orm['hack.hack'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('hack_hack_usage', ['hack_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field usage on 'Hack'
        db.delete_table('hack_hack_usage')
