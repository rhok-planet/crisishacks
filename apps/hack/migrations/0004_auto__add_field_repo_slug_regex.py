...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hack_repo', 'slug_regex', self.gf('django.db.models.fields.CharField')(default='', max_length='100', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Repo.slug_regex'
        db.delete_column('hack_repo', 'slug_regex')
