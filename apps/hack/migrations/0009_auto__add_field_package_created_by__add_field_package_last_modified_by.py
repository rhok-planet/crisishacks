...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Hack.created_by'
        db.add_column('hack_hack', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='creator', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Hack.last_modified_by'
        db.add_column('hack_hack', 'last_modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modifier', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Hack.created_by'
        db.delete_column('hack_hack', 'created_by_id')

        # Deleting field 'Hack.last_modified_by'
        db.delete_column('hack_hack', 'last_modified_by_id')
    ...
    models = {
        ...
        'hack.repo': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'handler': ('django.db.models.fields.CharField', [], {'default': "'hack.handlers.unsupported'", 'max_length': "'200'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hack.version': {
            ...
            'hack': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hack.Hack']", 'null': 'True', 'blank': 'True'})
        }
    }
