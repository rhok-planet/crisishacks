...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hack_category', 'title_plural', self.gf('django.db.models.fields.CharField')(default='', max_length='50', blank=True), keep_default=False)

        # Adding field 'Repo.is_other'
        db.add_column('hack_repo', 'is_other', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Repo.user_regex'
        db.add_column('hack_repo', 'user_regex', self.gf('django.db.models.fields.CharField')(default='', max_length='100', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.title_plural'
        db.delete_column('hack_category', 'title_plural')

        # Deleting field 'Repo.is_other'
        db.delete_column('hack_repo', 'is_other')

        # Deleting field 'Repo.user_regex'
        db.delete_column('hack_repo', 'user_regex')
